...
int main(int argc, char *argv[])
{
  ...
  std::vector<HDSA::Ptr<HDSA::MD_u_Prior_Interface<RealT>>> spatial_prior_interface_std;
  std::vector<HDSA::Ptr<HDSA::MD_Transient_Prior_Covariance<RealT>>> transient_prior_cov_std;
  std::vector<HDSA::Ptr<HDSA::MD_u_Prior_Interface<RealT>>> u_prior_interface_std;
  u_hyperparam_interface_std.resize(2);
  spatial_prior_interface_std.resize(2);
  transient_prior_cov_std.resize(2);
