...
class MD_u_Prior_Interface_synthetic_test_OED : public HDSA::MD_u_Prior_Interface<RealT>
{
...
public:
  MD_u_Prior_Interface_synthetic_test_OED(const HDSA::Ptr<HDSA::Random_Number_Generator<RealT>> &random_number_generator) : random_number_generator_(random_number_generator)
  {
    m_ = 51;
