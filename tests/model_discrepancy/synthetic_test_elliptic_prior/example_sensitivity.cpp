...
#include "MD_Data_Interface_synthetic_test_elliptic_prior.hpp"
#include "MD_Opt_Prob_Interface_synthetic_test_elliptic_prior.hpp"
#include "MD_Elliptic_u_Prior_Interface_synthetic_test_elliptic_prior.hpp"
#include "MD_Elliptic_z_Prior_Interface_synthetic_test_elliptic_prior.hpp"
...
int main(int argc, char *argv[])
{
  ...
  HDSA::Ptr<HDSA::MD_u_Prior_Interface<RealT>> u_prior_interface = HDSA::makePtr<MD_Elliptic_u_Prior_Interface_synthetic_test_elliptic_prior<RealT>>(alpha_u, random_number_generator);
  HDSA::Ptr<HDSA::MD_z_Prior_Interface<RealT>> z_prior_interface = HDSA::makePtr<MD_Elliptic_z_Prior_Interface_synthetic_test_elliptic_prior<RealT>>(alpha_z, random_number_generator);
