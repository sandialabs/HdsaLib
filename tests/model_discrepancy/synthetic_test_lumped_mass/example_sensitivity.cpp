...
int main(int argc, char *argv[])
{
  ...
  HDSA::Ptr<HDSA::MD_Lumped_Mass_u_Prior_Interface<RealT>> u_prior_interface = HDSA::makePtr<HDSA::MD_Lumped_Mass_u_Prior_Interface<RealT>>(S, M, data_interface, u_hyperparam_interface);
