...
#include "MD_Data_Interface_synthetic_test_hessian_gevp.hpp"
#include "MD_Opt_Prob_Interface_synthetic_test_hessian_gevp.hpp"
#include "MD_u_Prior_Interface_synthetic_test_hessian_gevp.hpp"
#include "MD_z_Prior_Interface_synthetic_test_hessian_gevp.hpp"
...
int main(int argc, char *argv[])
{
  ...
  HDSA::Ptr<HDSA::MD_Data_Interface<RealT>> data_interface = HDSA::makePtr<MD_Data_Interface_synthetic_test_hessian_gevp<RealT>>(random_number_generator);
  HDSA::Ptr<HDSA::MD_Opt_Prob_Interface<RealT>> opt_prob_interface = HDSA::makePtr<MD_Opt_Prob_Interface_synthetic_test_hessian_gevp<RealT>>();
  HDSA::Ptr<HDSA::MD_u_Prior_Interface<RealT>> u_prior_interface = HDSA::makePtr<MD_u_Prior_Interface_synthetic_test_hessian_gevp<RealT>>(random_number_generator);
  HDSA::Ptr<HDSA::MD_z_Prior_Interface<RealT>> z_prior_interface = HDSA::makePtr<MD_z_Prior_Interface_synthetic_test_hessian_gevp<RealT>>(random_number_generator);
