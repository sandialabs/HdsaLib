...
#ifndef HDSA_MD_DATA_INTERFACE_SYNTHETIC_TEST_HESSIAN_GEVP_HPP
#define HDSA_MD_DATA_INTERFACE_SYNTHETIC_TEST_HESSIAN_GEVP_HPP

#include "HDSA_MD_Data_Interface.hpp"
#include "HDSA_Std_Vector.hpp"

template <class RealT>
class MD_Data_Interface_synthetic_test_hessian_gevp : public HDSA::MD_Data_Interface<RealT>
{
...
public:
  MD_Data_Interface_synthetic_test_hessian_gevp(const HDSA::Ptr<HDSA::Random_Number_Generator<RealT>> &random_number_generator) : random_number_generator_(random_number_generator)
  {
    m_ = 51;
  ...
  virtual ~MD_Data_Interface_synthetic_test_hessian_gevp()
  {
  }
