...
#ifndef HDSA_MD_Z_PRIOR_INTERFACE_SYNTHETIC_TEST_CONTINUATION_HPP
#define HDSA_MD_Z_PRIOR_INTERFACE_SYNTHETIC_TEST_CONTINUATION_HPP

#include "HDSA_MD_z_Prior_Interface.hpp"

template <class RealT>
class MD_z_Prior_Interface_synthetic_test_continuation : public HDSA::MD_z_Prior_Interface<RealT>
{
...
public:
  MD_z_Prior_Interface_synthetic_test_continuation(const HDSA::Ptr<HDSA::Random_Number_Generator<RealT>> &random_number_generator) : random_number_generator_(random_number_generator)
  {
    m_ = 51;
  ...
  virtual ~MD_z_Prior_Interface_synthetic_test_continuation()
  {
  }
