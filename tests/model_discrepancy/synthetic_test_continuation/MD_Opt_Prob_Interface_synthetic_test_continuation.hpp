...
#ifndef HDSA_MD_OPT_PROB_INTERFACE_SYNTHETIC_TEST_CONTINUATION_HPP
#define HDSA_MD_OPT_PROB_INTERFACE_SYNTHETIC_TEST_CONTINUATION_HPP

#include "HDSA_MD_Opt_Prob_Interface.hpp"

template <class RealT>
class MD_Opt_Prob_Interface_synthetic_test_continuation : public HDSA::MD_Opt_Prob_Interface<RealT>
{
...
public:
  MD_Opt_Prob_Interface_synthetic_test_continuation()
  {
    m_ = 51;
  ...
  virtual ~MD_Opt_Prob_Interface_synthetic_test_continuation()
  {
  }
