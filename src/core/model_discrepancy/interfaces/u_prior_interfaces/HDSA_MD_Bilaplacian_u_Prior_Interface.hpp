...
namespace HDSA
{
  ...
  class MD_Bilaplacian_u_Prior_Interface : public HDSA::MD_Scaled_u_Prior_Interface<RealT>
  {
  ...
  public:
    ...
    void Apply_W_u_Acute_Plus_scalar_M_u_Inverse(HDSA::Vector<RealT> &u_out, const HDSA::Vector<RealT> &u_in, const RealT &scalar) const override
    {
      ...
      if (i < 0)
      {
        HDSA_TEST_FOR_EXCEPTION(true, std::logic_error,
                                "Error in HDSA::MD_Bilaplacian_u_Prior_Interface::Apply_W_u_Acute_Plus_scalar_M_u_Inverse: scalar has not been set by Precompute_W_u_Plus_scalar_M_u_Data" << std::endl);
      }
    ...
    void Sample_with_Covariance_W_u_Acute_Plus_scalar_M_u_Inverse(HDSA::MultiVector<RealT> &samples, const RealT &scalar) const override
    {
      ...
      {
        HDSA_TEST_FOR_EXCEPTION(true, std::logic_error,
                                "Error in HDSA::MD_Bilaplacian_u_Prior_Interface::Sample_with_Covariance_W_u_Acute_Plus_scalar_M_u_Inverse: scalar has not been set by Precompute_W_u_Plus_scalar_M_u_Data" << std::endl);
      }
    ...
    void Auxillary_Constructor()
    {
      ...
      {
        HDSA_TEST_FOR_EXCEPTION(true, std::logic_error,
                                "Error in HDSA::MD_Numeric_Bilaplacian_u_Prior_Interface: The value of beta_u must be specificed" << std::endl);
      }
    ...
    class Shifted_Bilaplacian_Operator : public HDSA::Linear_Operator<ScalarType>
    {
    private:
    ...
    public:
      Shifted_Bilaplacian_Operator(const HDSA::MD_Bilaplacian_u_Prior_Interface<ScalarType> *bilapliacian_u_prior_interface, const ScalarType scalar) : bilapliacian_u_prior_interface_(bilapliacian_u_prior_interface), scalar_(scalar)
      {
      }
